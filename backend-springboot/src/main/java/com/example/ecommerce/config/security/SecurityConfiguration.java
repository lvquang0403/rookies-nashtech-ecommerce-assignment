...
public class SecurityConfiguration {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http.cors().and().csrf().disable()
                ...
                .authorizeRequests()
                .mvcMatchers(HttpMethod.GET, "/api/v1/products/**").permitAll()
                .mvcMatchers(HttpMethod.GET, "/api/v1/attributes/**").permitAll()
                .mvcMatchers(HttpMethod.GET, "/api/v1/categories/**").permitAll()
                .mvcMatchers(HttpMethod.GET, "/api/v1/ratings/**").permitAll()
