...
ALTER TABLE public.attribute ALTER COLUMN attribute_id ADD GENERATED BY DEFAULT AS IDENTITY (
...
--
-- Name: attribute_product; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.attribute_product (
    attribute_product_id bigint NOT NULL,
...
--
-- Name: attribute_product_attribute_product_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

ALTER TABLE public.attribute_product ALTER COLUMN attribute_product_id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.attribute_product_attribute_product_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
CREATE TABLE public.orders (
    ...
    number_type_item integer,
    order_name character varying(255),
    order_phone character varying(255),
    order_state integer,
...
ALTER TABLE public.rating ALTER COLUMN rating_id ADD GENERATED BY DEFAULT AS IDENTITY (
...
--
-- Name: 43094; Type: BLOB; Schema: -; Owner: -
--

SELECT pg_catalog.lo_create('43094');
...
SELECT pg_catalog.setval('public.attribute_attribute_id_seq', 15, true);


--
-- Name: attribute_product_attribute_product_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('public.attribute_product_attribute_product_id_seq', 119, true);
...
SELECT pg_catalog.setval('public.cart_cart_id_seq', 17, true);
...
SELECT pg_catalog.setval('public.cart_item_cart_item_id_seq', 234, true);
...
SELECT pg_catalog.setval('public.customer_customer_id_seq', 13, true);
...
SELECT pg_catalog.setval('public.image_image_id_seq', 148, true);
...
SELECT pg_catalog.setval('public.rating_rating_id_seq', 26, true);
...
SELECT pg_catalog.lo_open('43094', 131072);
SELECT pg_catalog.lowrite(0, '\x69');
...
--
-- Name: attribute_product attribute_product_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.attribute_product
    ADD CONSTRAINT attribute_product_pkey PRIMARY KEY (attribute_product_id);
...
ALTER TABLE ONLY public.customer_roles
    ADD CONSTRAINT customer_roles_pkey PRIMARY KEY (customers_customer_id, roles_role_id);
...
--
-- Name: attribute_product uk5o51qv4bxm1gkpnd62kiyuqn3; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.attribute_product
    ADD CONSTRAINT uk5o51qv4bxm1gkpnd62kiyuqn3 UNIQUE (product_id, attribute_id);
...
ALTER TABLE ONLY public.cart_item
    ADD CONSTRAINT fk1uobyhgl1wvgt1jpccia8xxs3 FOREIGN KEY (cart_id) REFERENCES public.cart(cart_id) ON DELETE CASCADE;


--
-- Name: customer_roles fk2dxfa4ffc0u5nwesetoy670x1; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.customer_roles
    ADD CONSTRAINT fk2dxfa4ffc0u5nwesetoy670x1 FOREIGN KEY (customers_customer_id) REFERENCES public.customer(customer_id);


--
-- Name: product fk40cf7ec1u2j4r6tnrqrlifn2m; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.product
    ADD CONSTRAINT fk40cf7ec1u2j4r6tnrqrlifn2m FOREIGN KEY (order_item_id) REFERENCES public.cart_item(cart_item_id) ON DELETE CASCADE;
...
--
-- Name: cart_item fk924v2k9shuysam0ee0lo5yb43; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.cart_item
    ADD CONSTRAINT fk924v2k9shuysam0ee0lo5yb43 FOREIGN KEY (item_id) REFERENCES public.product(product_id) ON DELETE CASCADE;


--
-- Name: rating fk92d54lg7br8t0wb68h23u4jkn; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.rating
    ADD CONSTRAINT fk92d54lg7br8t0wb68h23u4jkn FOREIGN KEY (customer_id) REFERENCES public.customer(customer_id);


--
-- Name: customer fkam4cgy6fxmjm52m8otoph84m3; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.customer
    ADD CONSTRAINT fkam4cgy6fxmjm52m8otoph84m3 FOREIGN KEY (cart_id) REFERENCES public.cart(cart_id) ON DELETE CASCADE;


--
-- Name: image fkbq2xuqj5stuhl6eq8og1s5g7; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.image
    ADD CONSTRAINT fkbq2xuqj5stuhl6eq8og1s5g7 FOREIGN KEY (produc_id) REFERENCES public.product(product_id) ON DELETE CASCADE;
...
--
-- Name: cart_item fkiirb0xcrkx26fc31m128hsoxx; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.cart_item
    ADD CONSTRAINT fkiirb0xcrkx26fc31m128hsoxx FOREIGN KEY (order_item_id) REFERENCES public.product(product_id) ON DELETE CASCADE;
...
ALTER TABLE ONLY public.cart_item
    ADD CONSTRAINT fkjcyd5wv4igqnw413rgxbfu4nv FOREIGN KEY (product_id) REFERENCES public.product(product_id);


--
-- Name: customer_roles fkjsimpx0v4lec1xdrs531x571p; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.customer_roles
    ADD CONSTRAINT fkjsimpx0v4lec1xdrs531x571p FOREIGN KEY (roles_role_id) REFERENCES public.role(role_id);


--
-- Name: rating fklkuwie0au2dru36asng9nywmh; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.rating
    ADD CONSTRAINT fklkuwie0au2dru36asng9nywmh FOREIGN KEY (product_id) REFERENCES public.product(product_id) ON DELETE CASCADE;


--
-- Name: attribute_product fkmh3byg0xvw3supiufsutfx9kg; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.attribute_product
    ADD CONSTRAINT fkmh3byg0xvw3supiufsutfx9kg FOREIGN KEY (product_id) REFERENCES public.product(product_id) ON DELETE CASCADE;


--
-- Name: attribute_product fkn9b873lpwtfg9wyn9fioq0ck8; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.attribute_product
    ADD CONSTRAINT fkn9b873lpwtfg9wyn9fioq0ck8 FOREIGN KEY (attribute_id) REFERENCES public.attribute(attribute_id);
