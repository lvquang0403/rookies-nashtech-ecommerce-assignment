...
CREATE TABLE IF NOT EXISTS public.product (
                                ...
                                CONSTRAINT fk1mtsbur82frn64de7balymq9s FOREIGN KEY (category_id) REFERENCES public.category(category_id)
);
...
CREATE TABLE IF NOT EXISTS public.attribute_product (
                                          ...
                                          CONSTRAINT fkmh3byg0xvw3supiufsutfx9kg FOREIGN KEY (product_id) REFERENCES public.product(product_id) ON DELETE CASCADE,
                                          CONSTRAINT fkn9b873lpwtfg9wyn9fioq0ck8 FOREIGN KEY (attribute_id) REFERENCES public."attribute"(attribute_id)
);
...
CREATE TABLE IF NOT EXISTS public.image (
                              ...
                              CONSTRAINT fkbq2xuqj5stuhl6eq8og1s5g7 FOREIGN KEY (produc_id) REFERENCES public.product(product_id) ON DELETE CASCADE
);
...
ALTER TABLE public.cart_item ADD CONSTRAINT fk1uobyhgl1wvgt1jpccia8xxs3 FOREIGN KEY (cart_id) REFERENCES public.cart(cart_id);
